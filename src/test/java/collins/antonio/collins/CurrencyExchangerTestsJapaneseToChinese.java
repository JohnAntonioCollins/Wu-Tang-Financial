...
public class CurrencyExchangerTestsJapaneseToChinese {
    ...
    public void CurrencyExchangerTests() {
        ...
        */
        ...
        //Convert Japanese to Chinese
        Double inputCountry = 115.84;
        Double outputCountry = 6.92;
        Double inputAmount = 1000.00;

        Double outputAmount = 59.73; //expected based on above input values
