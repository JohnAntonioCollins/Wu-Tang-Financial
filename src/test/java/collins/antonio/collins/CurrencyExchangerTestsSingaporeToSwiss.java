...
public class CurrencyExchangerTestsSingaporeToSwiss {
    ...
    public void CurrencyExchangerTests() {
        ...
        */
        ...
        //Convert Singapore to Swiss
        Double inputCountry = 1.43;
        Double outputCountry = 1.01;
        Double inputAmount = 1000.00;

        Double outputAmount = 706.29; //expected based on above input values
