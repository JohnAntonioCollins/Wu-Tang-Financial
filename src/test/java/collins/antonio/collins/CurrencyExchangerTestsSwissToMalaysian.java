...
public class CurrencyExchangerTestsSwissToMalaysian {
    ...
    public void CurrencyExchangerTests() {
        ...
        */
        ...
        //Convert Swiss to Malaysian
        Double inputCountry = 1.01;
        Double outputCountry = 4.47;
        Double inputAmount = 1000.00;

        Double outputAmount = 4425.74; //expected based on above input values
