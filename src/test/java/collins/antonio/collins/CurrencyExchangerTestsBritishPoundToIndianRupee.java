...
public class CurrencyExchangerTestsBritishPoundToIndianRupee {
    ...
    public void CurrencyExchangerTests() {
        ...
        */
        ...
        //Convert British Pounds to Indian Rupee
        Double inputCountry = .94;
        Double outputCountry = 68.32;
        Double inputAmount = 1000.00;

        Double outputAmount = 72680.85; //expected based on above input values
