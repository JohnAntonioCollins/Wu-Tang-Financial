...
public class CurrencyExchangerTestsMalaysianToJapanese {
    ...
    public void CurrencyExchangerTests() {
        ...
        */
        ...
        //Convert Malaysian to Japanese
        Double inputCountry = 4.47;
        Double outputCountry = 115.84;
        Double inputAmount = 1000.00;

        Double outputAmount = 25914.98; //expected based on above input values
