...
public class CurrencyExchangerTestsIndianRuppeeToCanadianDollar {
    ...
    public void CurrencyExchangerTests() {
        ...
        */
        ...
        //Convert Dollar to Euro
        Double inputCountry = 68.32;
        Double outputCountry = 1.32;
        Double inputAmount = 1000.00;

        Double outputAmount = 19.32; //expected based on above input values
